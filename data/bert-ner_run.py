...
class NerProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "valid")), "dev")
    ...
    def get_labels(self):
        return ['B-art', 'B-eve', 'B-geo', 'B-gpe', 'B-nat','B-org', 'B-per', 'B-tim', 'I-art', 'I-eve', 'I-geo', 'I-gpe', 'I-org', 'I-per', 'I-tim', 'O', '[CLS]', '[SEP]']
